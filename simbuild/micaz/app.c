...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7b78458, const void *arg_0xb7b785f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7b298c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb79d3840), 
int (*key_eq_fn)(void *arg_0xb79d3c88, void *arg_0xb79d3e00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb78a29b8, int arg_0xb78a2b10);
static double RandomUniform(void );
...
typedef nx_struct my_msg_keyt {
  ...
  nx_uint8_t key[21];
} __attribute__((packed)) my_msg_key;
...
typedef nx_struct my_msg_nextt {
  nx_uint8_t next;
} __attribute__((packed)) my_msg_next;
...
typedef TMilli BraceletsC$MilliTimer$precision_tag;
...
static void BraceletsC$MilliTimer$fired(void );
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
uint8_t len);
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void BraceletsC$MilliTimer$startPeriodic(uint32_t dt);
#line 78
static void BraceletsC$MilliTimer$stop(void );
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
...
message_t * msg);
# 28 "BraceletsC.nc"
uint8_t BraceletsC$counter[1000];
...
static inline void BraceletsC$sendKey(void );
static void BraceletsC$sendNextStep(void );
...
static inline void BraceletsC$MilliTimer$fired(void );
...
#line 227
static inline void BraceletsC$Read$readDone(error_t result, uint16_t data);
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
inline static void BraceletsC$MilliTimer$stop(void ){
#line 78
...
#line 172
{
  ...
  if (BraceletsC$phase[sim_node()] == 0 && TOS_NODE_ID != __nesc_ntoh_uint8(msg->sendAddress.nxdata)) {
  ...
  if (((BraceletsC$phase[sim_node()] == 0 || BraceletsC$phase[sim_node()] == 1) || BraceletsC$phase[sim_node()] == 2) && len == sizeof(my_msg_next )) {
      sim_log_debug(160U, "radio_send", "Received special message! Passing to next phase\n");
      BraceletsC$phase[sim_node()] = 2;
      BraceletsC$MilliTimer$stop();
      return buf;
    }
  else 
#line 219
  ...
  {
    sim_log_error(161U, "radio_rec", "Receiving error \n");
  }
}
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb7644ac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb7644ac8) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb7644ac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb74de9f8, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb74de9f8, addr, msg, len);
#line 80
...
#line 75
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb7644108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb7644108, msg, error);
#line 110
}
#line 110
...
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void BraceletsC$MilliTimer$startPeriodic(uint32_t dt){
#line 64
...
#line 105
{
  ...
  if (err == SUCCESS) {
      ...
      BraceletsC$MilliTimer$startPeriodic(1000);
    }
  else 
    {
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb74de010, message_t * msg, error_t error){
#line 100
  switch (arg_0xb74de010) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb74de010, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb77fe650){
#line 75
  switch (arg_0xb77fe650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb77fe650);
#line 75
      break;
#line 75
    }
...
#line 41
{
  ...
  if (!BraceletsC$locked[sim_node()]) {
      ...
      my_msg_key *msg = (my_msg_key *)BraceletsC$Packet$getPayload(&BraceletsC$packet[sim_node()], sizeof(my_msg_key ));
...
#line 46
      ...
      if (BraceletsC$AMSend$send(AM_BROADCAST_ADDR, &BraceletsC$packet[sim_node()], sizeof(my_msg_key )) == SUCCESS) {
...
#line 227
{
  ...
  my_msg_t *msg = (my_msg_t *)BraceletsC$Packet$getPayload(&BraceletsC$packet[sim_node()], sizeof(my_msg_t ));
...
#line 230
  ...
  __nesc_hton_uint8(msg->counter.nxdata, BraceletsC$counter[sim_node()]);
  sim_log_debug(162U, "radio_pack", "Preparing the response with counter = %d \n", BraceletsC$counter[sim_node()]);

  BraceletsC$PacketAcknowledgements$requestAck(&BraceletsC$packet[sim_node()]);

  if (BraceletsC$AMSend$send(1, &BraceletsC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
      sim_log_debug(163U, "radio_send", "Packet passed to lower layer successfully!\n");
    }
}
...
#line 24
{
  /*BraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$readDone(SUCCESS, /*BraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16());
}
...
#line 74
{
  ...
  if (!BraceletsC$locked[sim_node()]) {
      ...
      my_msg_next *msg = (my_msg_next *)BraceletsC$Packet$getPayload(&BraceletsC$packet[sim_node()], sizeof(my_msg_next ));
...
#line 79
      ...
      __nesc_hton_uint8(msg->next.nxdata, 1);

      BraceletsC$PacketAcknowledgements$requestAck(&BraceletsC$packet[sim_node()]);

      if (BraceletsC$AMSend$send(BraceletsC$sendAddress[sim_node()], &BraceletsC$packet[sim_node()], sizeof(my_msg_next )) == SUCCESS) {
...
#line 133
{
  ...
  if (&BraceletsC$packet[sim_node()] == buf && err == SUCCESS) {
      ...
      sim_log_error(156U, "radio_send", "Send done error!");
    }
  ...
  if (BraceletsC$PacketAcknowledgements$wasAcked(&BraceletsC$packet[sim_node()])) {
      ...
      if (BraceletsC$phase[sim_node()] == 1) {
          BraceletsC$phase[sim_node()] = 2;
          sim_log_error(157U, "radio_send", "Special packet acked!\n");
          BraceletsC$MilliTimer$stop();
        }
    }
  else 
...

    {
      ...
      if (BraceletsC$phase[sim_node()] == 1) {
          sim_log_error(158U, "radio_ack", "ACK not received! Sending the special packet again...\n");
          BraceletsC$sendNextStep();
        }
    }
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module BraceletsC */
  if (!strcmp(varname, "BraceletsC$counter"))
  {
    *addr = (uintptr_t)&BraceletsC$counter[__nesc_mote];
    *size = sizeof(BraceletsC$counter[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module BraceletsC */
  BraceletsC$counter[__nesc_mote] = 0;
