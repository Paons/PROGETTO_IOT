...
typedef nx_struct my_info_msg {
  ...
  nx_uint32_t y;
  nx_uint8_t status;
} __attribute__((packed)) my_info_msg_t;
...
typedef nx_struct my_msg_key {
  ...
  nx_uint8_t key[21];
} __attribute__((packed)) my_msg_key_t;
...
typedef TMilli BraceletsC$Timer0$precision_tag;
typedef sensor_status_t BraceletsC$Read$val_t;
typedef TMilli BraceletsC$Timer1$precision_tag;
typedef TMilli BraceletsC$Timer2$precision_tag;
...
typedef TMilli /*BraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$precision_tag;
typedef sensor_status_t /*BraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$val_t;
...
static void BraceletsC$SplitControl$startDone(error_t error);
#line 138
static void BraceletsC$SplitControl$stopDone(error_t error);
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void BraceletsC$Timer0$fired(void );
# 60 "/opt/tinyos-main-2.1.2/tos/interfaces/Boot.nc"
static void BraceletsC$Boot$booted(void );
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void BraceletsC$AMSend$sendDone(
#line 103
message_t * msg, 
...
static void BraceletsC$Read$readDone(error_t result, BraceletsC$Read$val_t val);
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void BraceletsC$Timer1$fired(void );
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
uint8_t len);
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void BraceletsC$Timer2$fired(void );
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*BraceletsAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*BraceletsAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void /*BraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$fired(void );
# 55 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
static error_t /*BraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$read(void );
# 62 "/opt/tinyos-main-2.1.2/tos/interfaces/Init.nc"
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static error_t BraceletsC$SplitControl$start(void );
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void BraceletsC$Timer0$startPeriodic(uint32_t dt);
#line 78
static void BraceletsC$Timer0$stop(void );
...
uint8_t len);
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t BraceletsC$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 55 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
static error_t BraceletsC$Read$read(void );
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void BraceletsC$Timer1$startPeriodic(uint32_t dt);
#line 78
static void BraceletsC$Timer1$stop(void );
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
static error_t BraceletsC$PacketAcknowledgements$requestAck(
#line 53
message_t * msg);
#line 85
static bool BraceletsC$PacketAcknowledgements$wasAcked(
#line 80
message_t * msg);
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void BraceletsC$Timer2$startPeriodic(uint32_t dt);
# 29 "BraceletsC.nc"
uint32_t BraceletsC$last_x[1000];
uint32_t BraceletsC$last_y[1000];
uint8_t BraceletsC$phase[1000];
uint8_t BraceletsC$sendAddress[1000];
uint8_t BraceletsC$locked[1000];

message_t BraceletsC$packet[1000];

static void BraceletsC$sendKey(uint8_t type);
static void BraceletsC$alert(uint8_t type);

static void BraceletsC$alert(uint8_t type);
#line 55
static void BraceletsC$sendKey(uint8_t type);
#line 102
static inline void BraceletsC$Boot$booted(void );
...
static inline void BraceletsC$SplitControl$startDone(error_t err);
#line 121
static inline void BraceletsC$SplitControl$stopDone(error_t err);




static inline void BraceletsC$Timer0$fired(void );





static inline void BraceletsC$Timer1$fired(void );
...
static inline void BraceletsC$Timer2$fired(void );
...
static void BraceletsC$AMSend$sendDone(message_t *buf, error_t err);
#line 190
static inline message_t *BraceletsC$Receive$receive(message_t *buf, void *payload, uint8_t len);
#line 256
static inline void BraceletsC$Read$readDone(error_t result, sensor_status_t data);
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void /*BraceletsAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
static error_t /*BraceletsAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*BraceletsAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*BraceletsAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static error_t /*BraceletsAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*BraceletsAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void /*BraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$startOneShot(uint32_t dt);
# 63 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
static void /*BraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$readDone(error_t result, /*BraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$val_t val);
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
static uint16_t /*BraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16(void );
# 16 "FakeSensorP.nc"
sensor_status_t /*BraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$sensor_status[1000];




static inline error_t /*BraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$read(void );





static inline void /*BraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$fired(void );
...
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void BraceletsC$Timer2$startPeriodic(uint32_t dt){
#line 64
...
inline static void BraceletsC$Timer0$stop(void ){
#line 78
...
#line 190
{
  ...
  if (len == sizeof(my_msg_key_t )) {
      ...
      if (((TOS_NODE_ID == 1 || TOS_NODE_ID == 2) && !strcmp((char *)msg->key, RK1)) || ((TOS_NODE_ID == 3 || TOS_NODE_ID == 4) && !strcmp((char *)msg->key, RK2))) {
          ...
          if (BraceletsC$phase[sim_node()] == 0) {
              sim_log_debug(162U, "radio_send", "Device succesfully paired with %d\n", __nesc_ntoh_uint8(msg->sendAddress.nxdata));
              BraceletsC$phase[sim_node()] = 1;
              BraceletsC$sendAddress[sim_node()] = __nesc_ntoh_uint8(msg->sendAddress.nxdata);
              BraceletsC$Timer0$stop();
              BraceletsC$sendKey(1);
            }
          else {
            if (BraceletsC$phase[sim_node()] == 1 && __nesc_ntoh_uint8(msg->type.nxdata) == 1) {
                sim_log_debug(163U, "radio_send", "Received special packet! Passing to next step\n");
                BraceletsC$phase[sim_node()] = 2;
                if (TOS_NODE_ID % 2 == 0) {
#line 215
                  BraceletsC$Timer2$startPeriodic(10000);
                  }
                else {
#line 216
                  BraceletsC$Timer1$startPeriodic(60000);
                  }
              }
            else {
#line 219
              if (BraceletsC$phase[sim_node()] == 2 && __nesc_ntoh_uint8(msg->type.nxdata) == 0) {
                BraceletsC$sendKey(1);
                }
              }
            }
...
#line 223
    ...
    if (len == sizeof(my_info_msg_t )) {

        my_info_msg_t *msg = (my_info_msg_t *)payload;

        if (TOS_NODE_ID % 2 != 0) {
            BraceletsC$last_x[sim_node()] = __nesc_ntoh_uint32(msg->x.nxdata);
            BraceletsC$last_y[sim_node()] = __nesc_ntoh_uint32(msg->y.nxdata);
            BraceletsC$Timer1$startPeriodic(60000);
            if (__nesc_ntoh_uint8(msg->status.nxdata) == 4) {
                sim_log_debug(164U, "radio_rec", "Received INFO: %d, %d, FALLING\n", BraceletsC$last_x[sim_node()], BraceletsC$last_y[sim_node()]);
                BraceletsC$alert(4);
              }


            if (__nesc_ntoh_uint8(msg->status.nxdata) == 1) {
#line 242
              sim_log_debug(165U, "radio_rec", "Received INFO: %d, %d, STANDING\n", BraceletsC$last_x[sim_node()], BraceletsC$last_y[sim_node()]);
              }
#line 243
            if (__nesc_ntoh_uint8(msg->status.nxdata) == 2) {
#line 243
              sim_log_debug(166U, "radio_rec", "Received INFO: %d, %d, WALKING\n", BraceletsC$last_x[sim_node()], BraceletsC$last_y[sim_node()]);
              }
#line 244
            if (__nesc_ntoh_uint8(msg->status.nxdata) == 3) {
#line 244
              sim_log_debug(167U, "radio_rec", "Received INFO: %d, %d, RUNNING\n", BraceletsC$last_x[sim_node()], BraceletsC$last_y[sim_node()]);
              }
          }
      }
    else 
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb76c7ac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb76c7ac8) {
#line 78
    case 6:
#line 78
      __nesc_result = BraceletsC$Receive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb76c7ac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 103 "/opt/tinyos-main-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*BraceletsAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
inline static void /*BraceletsAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb754f2b0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb754f2b0, addr, msg, len);
#line 80
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*BraceletsAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
#line 75
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb76c7108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb76c7108, msg, error);
#line 110
}
#line 110
...
inline static bool BraceletsC$PacketAcknowledgements$wasAcked(message_t * msg){
#line 85
  unsigned char __nesc_result;
#line 85
...
# 78 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void BraceletsC$Timer1$stop(void ){
#line 78
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb76c4178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb76c4178, msg, payload, len);
#line 78
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t BraceletsC$SplitControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
#line 104
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void BraceletsC$Timer0$startPeriodic(uint32_t dt){
#line 64
...
#line 109
{
  ...
  if (err == SUCCESS) {
      ...
      BraceletsC$Timer0$startPeriodic(1000);
    }
  else {
      sim_log_debug(152U, "radio", "Radio error!\n");
      BraceletsC$SplitControl$start();
    }
}
...
#line 113
  BraceletsC$SplitControl$startDone(error);
#line 113
}
#line 113
# 96 "/opt/tinyos-main-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
...
#line 138
  BraceletsC$SplitControl$stopDone(error);
#line 138
}
#line 138
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*BraceletsAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  BraceletsC$AMSend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*BraceletsAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb75518a8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb75518a8) {
#line 100
    case 0U:
#line 100
      /*BraceletsAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb75518a8, msg, error);
#line 100
      break;
#line 100
    }
...
#line 126
{
  ...
  sim_log_debug(153U, "timer", "Pairing timer fired at %s.\n", sim_time_string());
  BraceletsC$sendKey(0);
}
...
#line 132
{
  ...
  sim_log_debug(154U, "timer", "Missing timer fired at %s.\n", sim_time_string());
  BraceletsC$alert(5);
}
...
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*BraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$startOneShot(uint32_t dt){
#line 73
...
#line 21
{
  /*BraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$startOneShot(10);
  return SUCCESS;
}

# 55 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
inline static error_t BraceletsC$Read$read(void ){
#line 55
  unsigned char __nesc_result;
#line 55

#line 55
  __nesc_result = /*BraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$read();
#line 55
...
#line 140
{
  ...
  sim_log_debug(155U, "timer", "Child timer fired at %s.\n", sim_time_string());
  BraceletsC$Read$read();
}
...
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t BraceletsC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*BraceletsAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
#line 80
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
inline static error_t BraceletsC$PacketAcknowledgements$requestAck(message_t * msg){
#line 59
  unsigned char __nesc_result;
#line 59
...
# 126 "/opt/tinyos-main-2.1.2/tos/interfaces/Packet.nc"
inline static void * BraceletsC$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 256
{
  ...
  my_info_msg_t *msg = (my_info_msg_t *)BraceletsC$Packet$getPayload(&BraceletsC$packet[sim_node()], sizeof(my_info_msg_t ));

#line 259
  if (msg == (void *)0 || result != SUCCESS) {
      return;
    }


  __nesc_hton_uint32(msg->x.nxdata, data.x);

  __nesc_hton_uint32(msg->y.nxdata, data.y);
  __nesc_hton_uint8(msg->status.nxdata, data.status);

  BraceletsC$PacketAcknowledgements$requestAck(&BraceletsC$packet[sim_node()]);

  if (BraceletsC$AMSend$send(BraceletsC$sendAddress[sim_node()], &BraceletsC$packet[sim_node()], sizeof(my_info_msg_t )) == SUCCESS) {
    }
}

# 63 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
inline static void /*BraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$readDone(error_t result, /*BraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$val_t val){
#line 63
  BraceletsC$Read$readDone(result, val);
#line 63
}
#line 63
...
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
inline static uint16_t /*BraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16(void ){
#line 52
  unsigned short __nesc_result;
#line 52
...
#line 27
{
  ...
  uint32_t x = /*BraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16() % 300;
  uint32_t y = /*BraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16() % 300;

  /*BraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$sensor_status[sim_node()].x = x + 38946875;
  /*BraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$sensor_status[sim_node()].y = y + 16641260;

  switch (/*BraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16() % 10) {


      case 0: 

        /*BraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$sensor_status[sim_node()].status = 4;
      break;


      case 1: 

        /*BraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$sensor_status[sim_node()].status = 1;
      break;
      case 2: 
      ...
      case 4: 
        ...
        /*BraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$sensor_status[sim_node()].status = 2;
      break;
      case 5: 
      ...
      case 7: 
        ...
        /*BraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$sensor_status[sim_node()].status = 3;
      break;
      case 8: 
  ...
  /*BraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$readDone(SUCCESS, /*BraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$sensor_status[sim_node()]);
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb73d13a8){
#line 83
  switch (arg_0xb73d13a8) {
#line 83
    case 0U:
#line 83
      BraceletsC$Timer0$fired();
#line 83
      break;
#line 83
    case 1U:
#line 83
      BraceletsC$Timer1$fired();
#line 83
      break;
#line 83
    case 2U:
#line 83
      BraceletsC$Timer2$fired();
#line 83
      break;
#line 83
    case 3U:
#line 83
      /*BraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb73d13a8);
#line 83
      break;
#line 83
    }
...
#line 55
{
  ...
  if (!BraceletsC$locked[sim_node()]) {

      my_msg_key_t *msg = (my_msg_key_t *)BraceletsC$Packet$getPayload(&BraceletsC$packet[sim_node()], sizeof(my_msg_key_t ));
...
#line 60
      ...
      __nesc_hton_uint8(msg->sendAddress.nxdata, TOS_NODE_ID);

      __nesc_hton_uint8(msg->type.nxdata, type);
      ...
      if (type == 0) {
          ...
          if (BraceletsC$AMSend$send(AM_BROADCAST_ADDR, &BraceletsC$packet[sim_node()], sizeof(my_msg_key_t )) == SUCCESS) {

              BraceletsC$locked[sim_node()] = 1;
            }
        }
      else 
        {
          ...
          BraceletsC$PacketAcknowledgements$requestAck(&BraceletsC$packet[sim_node()]);
          if (BraceletsC$AMSend$send(BraceletsC$sendAddress[sim_node()], &BraceletsC$packet[sim_node()], sizeof(my_msg_key_t )) == SUCCESS) {
...
#line 55
{
  /*BraceletsAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*BraceletsAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 6);
  return /*BraceletsAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}
...
#line 148
{
  ...
  if (&BraceletsC$packet[sim_node()] == buf && err == SUCCESS) {
      sim_log_debug(156U, "radio_send", "Packet sent...");
      BraceletsC$locked[sim_node()] = 0;
  ...
  if (BraceletsC$PacketAcknowledgements$wasAcked(&BraceletsC$packet[sim_node()])) {


      if (BraceletsC$phase[sim_node()] == 1) {
          BraceletsC$phase[sim_node()] = 2;
          if (TOS_NODE_ID % 2 == 0) {
#line 164
            BraceletsC$Timer2$startPeriodic(10000);
...
#line 166
          sim_log_debug(159U, "radio_send", "Special packet acked! Passing to next step...\n");
        }
      else {
        }
    }
...

    {
      ...
      if (BraceletsC$phase[sim_node()] == 1) {
          sim_log_error(160U, "radio_ack", "ACK not received! Sending the special packet again...\n");
          BraceletsC$sendKey(1);
        }
      else {
#line 179
        if (BraceletsC$phase[sim_node()] == 2) {

            sim_log_error(161U, "radio_ack", "info message ACK not received!\n");
          }
        }
    }
}
...
#line 40
{
  ...
  if (type == 5) {
      sim_log_debug(148U, "radio_send", "MISSING ALERT!!! Last seen at: %d, %d\n", BraceletsC$last_x[sim_node()], BraceletsC$last_y[sim_node()]);
      BraceletsC$Timer1$stop();
    }

  if (type == 4) {
      sim_log_debug(149U, "radio_send", "FALLING ALERT!!! Position: %d, %d\n", BraceletsC$last_x[sim_node()], BraceletsC$last_y[sim_node()]);
    }
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module BraceletsC */
  if (!strcmp(varname, "BraceletsC$last_x"))
  {
    *addr = (uintptr_t)&BraceletsC$last_x[__nesc_mote];
    *size = sizeof(BraceletsC$last_x[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "BraceletsC$last_y"))
  {
    *addr = (uintptr_t)&BraceletsC$last_y[__nesc_mote];
    *size = sizeof(BraceletsC$last_y[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "BraceletsC$phase"))
  {
    *addr = (uintptr_t)&BraceletsC$phase[__nesc_mote];
    *size = sizeof(BraceletsC$phase[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "BraceletsC$sendAddress"))
  {
    *addr = (uintptr_t)&BraceletsC$sendAddress[__nesc_mote];
    *size = sizeof(BraceletsC$sendAddress[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "BraceletsC$locked"))
  {
    *addr = (uintptr_t)&BraceletsC$locked[__nesc_mote];
    *size = sizeof(BraceletsC$locked[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "BraceletsC$packet"))
  {
    *addr = (uintptr_t)&BraceletsC$packet[__nesc_mote];
    *size = sizeof(BraceletsC$packet[__nesc_mote]);
    return 0;
  }
  ...
  if (!strcmp(varname, "/*BraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$sensor_status"))
  {
    *addr = (uintptr_t)&/*BraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$sensor_status[__nesc_mote];
    *size = sizeof(/*BraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$sensor_status[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module BraceletsC */
  memset((void *)&BraceletsC$last_x[__nesc_mote], 0, sizeof BraceletsC$last_x[__nesc_mote]);
  memset((void *)&BraceletsC$last_y[__nesc_mote], 0, sizeof BraceletsC$last_y[__nesc_mote]);
  BraceletsC$phase[__nesc_mote] = 0;
  memset((void *)&BraceletsC$sendAddress[__nesc_mote], 0, sizeof BraceletsC$sendAddress[__nesc_mote]);
  BraceletsC$locked[__nesc_mote] = 0;
  memset((void *)&BraceletsC$packet[__nesc_mote], 0, sizeof BraceletsC$packet[__nesc_mote]);
  ...
  /* Module FakeSensorP$0 */
  memset((void *)&/*BraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$sensor_status[__nesc_mote], 0, sizeof /*BraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$sensor_status[__nesc_mote]);
